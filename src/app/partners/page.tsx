...
const Partners = () => {
    return (
      ...
      <TilePartner imagesrc="/partners/unlab.webp" name="" title="UN Lab" description="The Ultrabroadband Nano-networking Laboratory is a graduate research lab on Northeastern’s campus. They conduct research into advanced communications technology and are building the payload (a Terahertz band transmitter and receiver) that will ultimately fly on THIS-SAT." />
