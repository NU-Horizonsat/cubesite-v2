...
const Partners = () => {
    return (
      ...
      <TilePartner imagesrc="/partners/nasa.png" name="" title="NASA" description="NASA CSLI is a program offers an opportunity for universities, high schools, and non-profit organizations in the United States to access space. They provide us cost-effective pathway for building, testing and launching TeraLink." />
      <TilePartner imagesrc="/partners/unlab.webp" name="" title="UNLab" description="The Ultrabroadband Nano-networking Laboratory is a graduate research lab on Northeastern’s campus. They conduct research into advanced communications technology and are building the payload (a Terahertz band transmitter and receiver) that will ultimately fly on TeraLink." />
