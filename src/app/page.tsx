  ...
  return (
    <main className="bg-gradient-to-b from-black from-30% via-black via-50% to-red to-90%">
      ...
      <h1 className=" text-white text-5xl text-left">Projects</h1>
        <TileProject
          name="TeraLink"
          description="TeraLink is a satellite for testing terahertz-frequency low-earth orbit RF communication. It aims to be the first THz test platform to demonstrate and better understand this form of communication for uplink, downlink, and inter-satellite link in LEO."
          id="modal1"
          long_desc='Terahertz in Space Satellite is the current primary focus of Project Horizon. TeraLink launches as one 12U satellite and, upon initial communication with ground after orbital insertion, splits into two fully functional 6U satellites using a high-accuracy ultra-low-velocity splitting mechanism. Post-split, each 6U satellite will serve as one half of the first test platform for terahertz-frequency RF communication in low-earth orbit. TeraLink’s mission is to demonstrate and better understand the properties of high-throughput terahertz-frequency RF uplink, downlink, and inter-satellite link in the LEO environment. Developed by Northeastern’s Ultrabroadband Nanonetworking Laboratory, the terahertz RF payload launching on TeraLink has the potential to upend high-throughput orbital communication.'
